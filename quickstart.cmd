...
echo Write-Host "=========================================================" -ForegroundColor White
echo Write-Host ""
echo $openConfig = Read-Host "Do you want to run the edit the config.json? (Needed for first run) (y/n)"
echo if ($openConfig -eq "y" -or $openConfig -eq "Y"^) {
...
echo }
echo Write-Host ""
echo Write-Host "Run the patch everytime you boot up your PC?" -ForegroundColor White
echo Write-Host "This is recommended to avoid Ableton removing the patch after updates." -ForegroundColor White
echo Write-Host "You will have to run RePatch manually. Run repatch.ps1 as Administrator for that." -ForegroundColor White
